export const authorMetricsData = {
  ...
  metrics: [
    {
      value: '100K+',
      description: 'daily transactions, without breaking a sweat',
    },
    { value: '99.5%', description: 'uptime — engineered in, not hoped for' },
    { value: '0', description: 'deployment failures tolerated, ever' },
  ],
  features: [
    {
